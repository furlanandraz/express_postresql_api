...
export default async function resourceRouteItemTree() {
  ...
  try {
    ...
    return {language_default: languageDefault, route_tree: buildRouteItemTree(languages, routes.rows).at(0)};
...
export function buildRouteItemTree(languages, routes, parentId = null) {
